return {
	...
	config = function()
		...
		local ts_context_comment_string = require(
        "ts_context_commentstring.integrations.comment_nvim")

		-- setup the comment plugin to use ts_context_comment_string to check 
        -- if we are attempting to comment out a tsx element
