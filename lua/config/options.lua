...
vim.opt.scrolloff = 10 -- number of lines always above/below cursor
vim.opt.sidescrolloff = 8 -- number of lines always left/right of cursor

-- Tabbing and spacing
vim.opt.expandtab = true -- convert tabs to spaces
vim.opt.shiftwidth = 4 -- number of spaces inserted for each indentation level
vim.opt.tabstop = 4 -- number of spaces inserted per tab character
...
vim.opt.clipboard = "unnamed,unnamedplus" -- copy into system clipboard

--Searching Behaviours
vim.opt.hlsearch = true -- highlight all matches in search
vim.opt.ignorecase = true -- ignore case in search
vim.opt.smartcase = true -- match case when explicitly stated
